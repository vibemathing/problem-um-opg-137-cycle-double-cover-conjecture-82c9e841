...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-137-cycle-double-cover-conjecture-82c9e841-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-137"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-137-cycle-double-cover-conjecture-82c9e841-v1",
      "problem_contract_sha256": "b301c53e59e400c63e660b0f319b5005c4d23aebb09e5782f31a18951a055d96",
      "problem_id": "problem:um-opg-137-cycle-double-cover-conjecture-82c9e841",
      "route_id": "route:um-opg-137-cycle-double-cover-conjecture-82c9e841-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-137-cycle-double-cover-conjecture-82c9e841-source-fidelity-01",
      "graph_id": "graph:um-opg-137-cycle-double-cover-conjecture-82c9e841-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-137-cycle-double-cover-conjecture-82c9e841-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-137-cycle-double-cover-conjecture-82c9e841-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Conjecture For every graph with no bridge, there is a list of cycles so that every edge is contained in exactly two."
          },
          "statement_sha256": "37b26ef878e957e70ad529e86cdef880a8c75c8efb97729844cf1121f3888726"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-137-cycle-double-cover-conjecture-82c9e841-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-137-cycle-double-cover-conjecture-82c9e841-root",
      "route_id": "route:um-opg-137-cycle-double-cover-conjecture-82c9e841-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-137-de15436dddf9",
        "url": "https://www.unsolvedmath.com/problems/OPG-137"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
